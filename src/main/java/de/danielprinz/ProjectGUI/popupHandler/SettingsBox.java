...
public class SettingsBox {
    ...
    public static void display(String title) {
        ...
        /*
         * print image max width
         */
        Label printImgWidthLabel = new Label("Print image max width:");
        printImgWidthLabel.setMinWidth(fontLoader.computeStringWidth(printImgWidthLabel.getText(), printImgWidthLabel.getFont()));
        GridPane.setConstraints(printImgWidthLabel, 0, 3);

        TextField printImgWidthTextField = new TextField(String.valueOf(SettingsHandler.PRINT_IMAGE_MAX_WIDTH));
        // force the field to be numeric only
        printImgWidthTextField.textProperty().addListener((observable, oldValue, newValue) -> {
            if(newValue.equals("")) return;
            try {
                Integer.parseInt(newValue);
            } catch (NumberFormatException e) {
                printImgWidthTextField.setText(oldValue);
            }
        });
        GridPane.setConstraints(printImgWidthTextField, 1, 3);

        /*
         * print image max height
         */
        Label printImgHeightLabel = new Label("Print image max height:");
        printImgHeightLabel.setMinWidth(fontLoader.computeStringWidth(printImgHeightLabel.getText(), printImgHeightLabel.getFont()));
        GridPane.setConstraints(printImgHeightLabel, 0, 4);

        TextField printImgHeightTextField = new TextField(String.valueOf(SettingsHandler.PRINT_IMAGE_MAX_HEIGHT));
        // force the field to be numeric only
        printImgHeightTextField.textProperty().addListener((observable, oldValue, newValue) -> {
            if(newValue.equals("")) return;
            try {
                Integer.parseInt(newValue);
            } catch (NumberFormatException e) {
                printImgHeightTextField.setText(oldValue);
            }
        });
        GridPane.setConstraints(printImgHeightTextField, 1, 4);
        ...
        GridPane.setConstraints(handdrawingMovementSpeedLabel, 0, 5);
        ...
        GridPane.setConstraints(handdrawingMovementSpeedTextField, 1, 5);
        ...
        GridPane.setConstraints(serialConnectionTimeoutLabel, 0, 6);
        ...
        GridPane.setConstraints(serialConnectionTimeoutTextField, 1, 6);
        ...
        GridPane.setConstraints(serialConnectionCommandsSentPerSecondLabel, 0, 7);
        ...
        GridPane.setConstraints(serialConnectionCommandsSentPerSecondTextField, 1, 7);
        ...
        save.setOnAction(event -> {
            ...
            SettingsHandler.PRINT_IMAGE_MAX_WIDTH = printImgWidthTextField.getText().equalsIgnoreCase("") ? 1000 : Integer.parseInt(printImgWidthTextField.getText());
            SettingsHandler.PRINT_IMAGE_MAX_HEIGHT = printImgHeightTextField.getText().equalsIgnoreCase("") ? 1000 : Integer.parseInt(printImgHeightTextField.getText());
        ...
        grid.getChildren().addAll(portLabel, portComboBox, prevImgWidthLabel, prevImgWidthTextField, prevImgHeightLabel, prevImgHeightTextField,
                printImgWidthLabel, printImgWidthTextField, printImgHeightLabel, printImgHeightTextField,
